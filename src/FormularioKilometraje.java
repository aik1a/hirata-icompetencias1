 ...
 */
public class FormularioKilometraje extends JFrame {
     ...
     */
    public FormularioKilometraje() {
        // Configuración general de la ventana
        setTitle("Hirata - Registro de Kilometraje");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FormularioKilometraje().setVisible(true);
            }
        });
    }
}
